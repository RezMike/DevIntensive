...
public class UserDTO implements Parcelable {
    ...
    public UserDTO(UserListRes.Data userData) {
        ...
        ;
        mBio = String.valueOf(userData.getPublicInfo().getBio());
        ;

        for (UserInfoRes.Repo gitLink : userData.getRepositories().getRepo()) {
